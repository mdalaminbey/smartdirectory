...
$total_posts  = wp_count_posts( smart_directory_post_type() )->publish;
?>
<div class="smart-directory directory-list-body" data-api="smart-directory/v1/directory">
	<div class="grid grid-cols-3 gap-8 directory-list" data-total="<?php echo esc_attr( $total_posts ) ?>">
