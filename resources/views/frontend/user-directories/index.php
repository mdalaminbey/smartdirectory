...
?>
<div class="smart-directory directory-list-body" data-api="smart-directory/v1/directory/user-directories">
	...
	<div class="overflow-hidden">
		<table class="border border-[#EDF1F7] table-auto w-full text-base">
			...
			<tbody class="directory-list" data-total="<?php echo esc_attr( $total_posts ) ?>">
